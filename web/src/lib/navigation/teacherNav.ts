...
export const studentNavSections = [
  {
    ...
    items: [
      ...
      { label: "Notities", icon: NotesIcon, path: "/docent-notities" }, //docent kan persoonlijke notes sturen naar studenten als het nu over hun cijfers is, hun mentale gezondheid etc.
      { label: "Cijferlijst", icon: ProgressIcon, path: "/docent-cijferlijst" }, //de docent houdt hier de cijfers van de studenten bij. de docent kan dus cijfers toevoegen, wijzigen en verwijderen. eventueel ziet student zijn/haar cijfer ook in hun dashboard.
