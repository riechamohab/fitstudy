...
export const adminNavSections = [
  {
    title: "Centraal",
    items: [
      { label: "Statistieken", icon: StatisticsIcon, path: "/admin/statistieken" }, //ik denk dat we hier gewoon statistics kunnen plaatsen.. misschien x studenten en x docenten for now in cards aantonen en elke keer er een nieuwe erbij geplaatst wordt dan klimt het getal etc
